-- Corrige update_product_atomic y create_product_variants_atomic para que
-- respeten el campo `activo` (visibilidad en tienda).
-- Sin este fix, desmarcar visibilidad en el admin no se persistía en BD.
...
-- Corrige create_product_variants_atomic para incluir activo en el INSERT.
