"""
Genera docs/AUDITORIA-EXHAUSTIVA-2026-05.docx desde el markdown homónimo.
Ejecutar: python scripts/build_audit_exhaustiva_docx.py
...
OUT_PATH = ROOT / "docs" / "AUDITORIA-EXHAUSTIVA-2026-05.docx"
...
def main() -> None:
    ...
    core.title = "Auditoría exhaustiva — Calzatura Vilchez (web)"
    core.subject = "Calidad, CI, dependencias, A1–A8"
    core.keywords = "auditoría, ISO, Supabase, E2E"
    ...
    foot = doc.add_paragraph(
        "Documento generado desde AUDITORIA-EXHAUSTIVA-2026-05.md — "
        "Regenerar con: python scripts/build_audit_exhaustiva_docx.py"
    )
    foot.italic = True
